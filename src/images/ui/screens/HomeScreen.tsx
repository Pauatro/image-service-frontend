...
export const HomeScreen: FC = () => {
  ...
  const { canvasRef, getImage, patientName, getPatientName } = useImageData();
  ...
  return (
    <div className="p-8 flex flex-col items-center justify-center">
      <div className="w-1/2 max-w-4xl min-w-min flex flex-col gap-2 items-center">
        ...
        <Button className="pb-2" onClick={getImage}>
          Get Image
        </Button>
        <canvas ref={canvasRef as React.Ref<HTMLCanvasElement>} id="canvas" />
      </div>
    </div>
  );
};
